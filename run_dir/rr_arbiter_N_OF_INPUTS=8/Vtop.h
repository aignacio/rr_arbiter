...
VL_MODULE(Vtop) {
  public:
    ...
    CData/*7:0*/ rr_arbiter__DOT__req_i;
    CData/*7:0*/ rr_arbiter__DOT__grant_o;
    CData/*7:0*/ rr_arbiter__DOT__mask_ff;
    CData/*7:0*/ rr_arbiter__DOT__next_mask;
    CData/*7:0*/ rr_arbiter__DOT__grant_ff;
    CData/*7:0*/ rr_arbiter__DOT__next_grant;
