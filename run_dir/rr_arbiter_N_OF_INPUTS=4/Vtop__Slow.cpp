...
void Vtop::_settle__TOP__2(Vtop__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->update_i) {
        ...
        {
            while (VL_GTS_III(1,32,32, 4U, vlTOPp->rr_arbiter__DOT__unnamedblk2__DOT__i)) {
                if ((1U & ((IData)(vlTOPp->req_i) >> 
                           (3U & vlTOPp->rr_arbiter__DOT__unnamedblk2__DOT__i)))) {
                    ...
                    vlTOPp->rr_arbiter__DOT__next_mask 
                        = ((IData)(vlTOPp->rr_arbiter__DOT__next_mask) 
                           | ((IData)(1U) << (3U & vlTOPp->rr_arbiter__DOT__unnamedblk2__DOT__i)));
                }
                vlTOPp->rr_arbiter__DOT__unnamedblk2__DOT__i 
        ...
        if ((0U == (IData)(vlTOPp->rr_arbiter__DOT__next_mask))) {
            vlTOPp->rr_arbiter__DOT__next_mask = 0xfU;
        }
    }
...
void Vtop::_ctor_var_reset() {
    ...
    req_i = VL_RAND_RESET_I(4);
    grant_o = VL_RAND_RESET_I(4);
    rr_arbiter__DOT__clk = VL_RAND_RESET_I(1);
    rr_arbiter__DOT__arst = VL_RAND_RESET_I(1);
    rr_arbiter__DOT__update_i = VL_RAND_RESET_I(1);
    rr_arbiter__DOT__req_i = VL_RAND_RESET_I(4);
    rr_arbiter__DOT__grant_o = VL_RAND_RESET_I(4);
    rr_arbiter__DOT__mask_ff = VL_RAND_RESET_I(4);
    rr_arbiter__DOT__next_mask = VL_RAND_RESET_I(4);
    rr_arbiter__DOT__grant_ff = VL_RAND_RESET_I(4);
    rr_arbiter__DOT__next_grant = VL_RAND_RESET_I(4);
