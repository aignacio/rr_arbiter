...
VL_MODULE(Vtop) {
  public:
    ...
    CData/*0:0*/ rr_arbiter__DOT__clk;
    CData/*0:0*/ rr_arbiter__DOT__arst;
    CData/*0:0*/ rr_arbiter__DOT__update_i;
    CData/*3:0*/ rr_arbiter__DOT__req_i;
    CData/*3:0*/ rr_arbiter__DOT__grant_o;
    CData/*3:0*/ rr_arbiter__DOT__mask_ff;
    CData/*3:0*/ rr_arbiter__DOT__next_mask;
    CData/*3:0*/ rr_arbiter__DOT__grant_ff;
    CData/*3:0*/ rr_arbiter__DOT__next_grant;
    IData/*31:0*/ rr_arbiter__DOT__unnamedblk2__DOT__i;
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ __Vclklast__TOP__arst;
    CData/*0:0*/ __Vclklast__TOP__clk;
    IData/*31:0*/ __Vfunc_rr_arbiter__DOT__count_ones__0__Vfuncout;
    IData/*31:0*/ __Vfunc_rr_arbiter__DOT__count_ones__0__ones;
