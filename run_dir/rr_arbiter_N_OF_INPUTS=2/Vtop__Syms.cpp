    ...
    // Setup submodule names
{
    ...
    for (int __Vfinal=0; __Vfinal<2; __Vfinal++) {
        ...
        __Vscope_TOP.varInsert(__Vfinal,"grant_o", &(TOPp->grant_o), false, VLVT_UINT8,VLVD_OUT|VLVF_PUB_RW,1 ,1,0);
        __Vscope_TOP.varInsert(__Vfinal,"req_i", &(TOPp->req_i), false, VLVT_UINT8,VLVD_IN|VLVF_PUB_RW,1 ,1,0);
        ...
        __Vscope_rr_arbiter.varInsert(__Vfinal,"grant_ff", &(TOPp->rr_arbiter__DOT__grant_ff), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
        __Vscope_rr_arbiter.varInsert(__Vfinal,"grant_o", &(TOPp->rr_arbiter__DOT__grant_o), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
        __Vscope_rr_arbiter.varInsert(__Vfinal,"mask_ff", &(TOPp->rr_arbiter__DOT__mask_ff), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
        __Vscope_rr_arbiter.varInsert(__Vfinal,"next_grant", &(TOPp->rr_arbiter__DOT__next_grant), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
        __Vscope_rr_arbiter.varInsert(__Vfinal,"next_mask", &(TOPp->rr_arbiter__DOT__next_mask), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
        __Vscope_rr_arbiter.varInsert(__Vfinal,"req_i", &(TOPp->rr_arbiter__DOT__req_i), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,1,0);
