...
void Vtop::traceChgSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+3,(vlTOPp->req_i),2);
        tracep->chgCData(oldp+4,(vlTOPp->grant_o),2);
        ...
        tracep->chgCData(oldp+8,(vlTOPp->rr_arbiter__DOT__req_i),2);
        tracep->chgCData(oldp+9,(vlTOPp->rr_arbiter__DOT__grant_o),2);
        tracep->chgCData(oldp+10,(vlTOPp->rr_arbiter__DOT__mask_ff),2);
        tracep->chgCData(oldp+11,(vlTOPp->rr_arbiter__DOT__next_mask),2);
        tracep->chgCData(oldp+12,(vlTOPp->rr_arbiter__DOT__grant_ff),2);
        tracep->chgCData(oldp+13,(vlTOPp->rr_arbiter__DOT__next_grant),2);
