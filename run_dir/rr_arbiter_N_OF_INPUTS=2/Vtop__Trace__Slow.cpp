...
void Vtop::traceInitSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+4,"req_i",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 1,0);
        tracep->declBus(c+5,"grant_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 1,0);
        ...
        tracep->declBus(c+9,"rr_arbiter req_i",-1,FST_VD_INPUT,FST_VT_VCD_WIRE, false,-1, 1,0);
        tracep->declBus(c+10,"rr_arbiter grant_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 1,0);
        tracep->declBus(c+11,"rr_arbiter mask_ff",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
        tracep->declBus(c+12,"rr_arbiter next_mask",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
        tracep->declBus(c+13,"rr_arbiter grant_ff",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
        tracep->declBus(c+14,"rr_arbiter next_grant",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
...
void Vtop::traceFullSub0(void* userp, VerilatedFst* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+4,(vlTOPp->req_i),2);
        tracep->fullCData(oldp+5,(vlTOPp->grant_o),2);
        ...
        tracep->fullCData(oldp+9,(vlTOPp->rr_arbiter__DOT__req_i),2);
        tracep->fullCData(oldp+10,(vlTOPp->rr_arbiter__DOT__grant_o),2);
        tracep->fullCData(oldp+11,(vlTOPp->rr_arbiter__DOT__mask_ff),2);
        tracep->fullCData(oldp+12,(vlTOPp->rr_arbiter__DOT__next_mask),2);
        tracep->fullCData(oldp+13,(vlTOPp->rr_arbiter__DOT__grant_ff),2);
        tracep->fullCData(oldp+14,(vlTOPp->rr_arbiter__DOT__next_grant),2);
